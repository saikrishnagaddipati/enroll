class Insured::FamiliesController < FamiliesController
  ...
  def home
    ...
    if @employee_role.present?
     @benefit_group = (@employee_role.census_employee.active_benefit_group_assignment || @employee_role.census_employee.renewal_benefit_group_assignment).benefit_group
    end
